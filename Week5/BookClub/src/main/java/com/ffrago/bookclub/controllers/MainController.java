package com.ffrago.bookclub.controllers;
...
import com.ffrago.bookclub.services.BookService;
import com.ffrago.bookclub.services.UserService;
...
//Delete Item
	...
	public String deleteBook(@PathVariable("id") Book id) {
